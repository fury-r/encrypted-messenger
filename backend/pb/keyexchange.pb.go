...
func (x *PubKeyExchange) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
func (x *PubKeyExchange) GetReciever() string {
	if x != nil {
		return x.Reciever
	}
	return ""
...
func (x *PubKeyExchange) GetEncryptedKey() string {
	if x != nil {
...
var file_keyexchange_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x68, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x45, 0x78, 0x63,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18,
	...
	0x08, 0x72, 0x65, 0x63, 0x69, 0x65, 0x76, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x0c, 0x65, 0x6e, 0x63,
	0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0c, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x42, 0x13, 0x0a,
...
var file_keyexchange_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_keyexchange_proto_goTypes = []interface{}{
	(*PubKeyExchange)(nil), // 0: PubKeyExchange
}
