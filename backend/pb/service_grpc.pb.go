...
const (
	...
	Services_DownloadFromServer_FullMethodName         = "/Services/downloadFromServer"
	Services_RotateKey_FullMethodName                  = "/Services/rotateKey"
	Services_UpdateUpiIntegration_FullMethodName       = "/Services/updateUpiIntegration"
	Services_UpdateEcommerceIntegration_FullMethodName = "/Services/updateEcommerceIntegration"
)
...
type ServicesClient interface {
	...
	DownloadFromServer(ctx context.Context, in *RequestDownload, opts ...grpc.CallOption) (*ResponseDownload, error)
	RotateKey(ctx context.Context, in *KeyRotationRequest, opts ...grpc.CallOption) (*KeyRotationResponse, error)
	UpdateUpiIntegration(ctx context.Context, in *UpiIntegrationRequest, opts ...grpc.CallOption) (*UpiIntegrationResponse, error)
	UpdateEcommerceIntegration(ctx context.Context, in *EcommerceIntegrationRequest, opts ...grpc.CallOption) (*EcommerceIntegrationResponse, error)
}
...
func (c *servicesClient) DownloadFromServer(ctx context.Context, in *RequestDownload, opts ...grpc.CallOption) (*ResponseDownload, error) {
	out := new(ResponseDownload)
	err := c.cc.Invoke(ctx, Services_DownloadFromServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesClient) RotateKey(ctx context.Context, in *KeyRotationRequest, opts ...grpc.CallOption) (*KeyRotationResponse, error) {
	out := new(KeyRotationResponse)
	err := c.cc.Invoke(ctx, Services_RotateKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesClient) UpdateUpiIntegration(ctx context.Context, in *UpiIntegrationRequest, opts ...grpc.CallOption) (*UpiIntegrationResponse, error) {
	out := new(UpiIntegrationResponse)
	err := c.cc.Invoke(ctx, Services_UpdateUpiIntegration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesClient) UpdateEcommerceIntegration(ctx context.Context, in *EcommerceIntegrationRequest, opts ...grpc.CallOption) (*EcommerceIntegrationResponse, error) {
	out := new(EcommerceIntegrationResponse)
	err := c.cc.Invoke(ctx, Services_UpdateEcommerceIntegration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServicesServer interface {
	...
	DownloadFromServer(context.Context, *RequestDownload) (*ResponseDownload, error)
	RotateKey(context.Context, *KeyRotationRequest) (*KeyRotationResponse, error)
	UpdateUpiIntegration(context.Context, *UpiIntegrationRequest) (*UpiIntegrationResponse, error)
	UpdateEcommerceIntegration(context.Context, *EcommerceIntegrationRequest) (*EcommerceIntegrationResponse, error)
...
func (UnimplementedServicesServer) DownloadFromServer(context.Context, *RequestDownload) (*ResponseDownload, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DownloadFromServer not implemented")
}
func (UnimplementedServicesServer) RotateKey(context.Context, *KeyRotationRequest) (*KeyRotationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RotateKey not implemented")
}
func (UnimplementedServicesServer) UpdateUpiIntegration(context.Context, *UpiIntegrationRequest) (*UpiIntegrationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateUpiIntegration not implemented")
}
func (UnimplementedServicesServer) UpdateEcommerceIntegration(context.Context, *EcommerceIntegrationRequest) (*EcommerceIntegrationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEcommerceIntegration not implemented")
}
...
func _Services_DownloadFromServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestDownload)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).DownloadFromServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Services_DownloadFromServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).DownloadFromServer(ctx, req.(*RequestDownload))
	}
	return interceptor(ctx, in, info, handler)
}

func _Services_RotateKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KeyRotationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).RotateKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Services_RotateKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).RotateKey(ctx, req.(*KeyRotationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Services_UpdateUpiIntegration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpiIntegrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).UpdateUpiIntegration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Services_UpdateUpiIntegration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).UpdateUpiIntegration(ctx, req.(*UpiIntegrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Services_UpdateEcommerceIntegration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EcommerceIntegrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServicesServer).UpdateEcommerceIntegration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Services_UpdateEcommerceIntegration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServicesServer).UpdateEcommerceIntegration(ctx, req.(*EcommerceIntegrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Services_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "downloadFromServer",
			Handler:    _Services_DownloadFromServer_Handler,
		},
		{
			MethodName: "rotateKey",
			Handler:    _Services_RotateKey_Handler,
		},
		{
			MethodName: "updateUpiIntegration",
			Handler:    _Services_UpdateUpiIntegration_Handler,
		},
		{
			MethodName: "updateEcommerceIntegration",
			Handler:    _Services_UpdateEcommerceIntegration_Handler,
		},
	},
