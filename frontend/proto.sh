...
#!/usr/bin/bash
#windows command
 protoc --plugin=protoc-gen-kotlin=./script.sh --experimental_allow_proto3_optional --kotlin_out=./app/src/main/java --java_out=./app/src/main/java --proto_path=../protobuf/service ../protobuf/service/*.proto
#linux command
